...
function playAll() {
    ...
    if(g_n>=g_channelNumber||(g_playStyle==1&&g_n>=g_channelNumber-g_DigChannel))//总路数
    {
        clearInterval(aa);         
        g_clicked=1;
...
function ClickHi() {
    ...
    {
        g_playStyle=0;
        aa=setInterval("playAll()",10)//时间间隔
    }
    else
    {   g_playStyle=1;
...
function MessageBox() {
wrap="<div id='versionB' style='position:absolute;font-family: 宋体, Arial, Helvetica, sans-serif;color: #000000;width:215px;height:220px;margin:200px 0 0 50%;z-index:1000;background-color: RGB(255,255,255)'>"
        +"<div style='background-color: RGB(242,242,242);width:215px;height:30px;'>"
            ...
            +"<div style='width:215px;height:160px;'>"
                ...
                +Versions.videoIn+g_VideoInChannel+"<br/>"
